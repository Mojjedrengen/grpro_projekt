...
public void act(World world) {
    ...
    public void eat(World world) {
        ...
        if(world.containsNonBlocking(currentLocation)) {
            ...
            if(nonBlockable instanceof Grass grass && (!this.hasEatenToday || this.getEnergy() != this.maxEnergy )) { //Makes sure that rabbits dont stuff themselves if they've already eaten that day)
                grass.consume(world);
